...
# Inicio: lun mar 18 12:27:09 CST 2019
# Para: Avignon
###
# -*- coding: utf-8 -*-
import pandas as pd
...
values = [
        data[data['Cadena'] == 'DZ']['Orden y Limpieza'].mean(), 
        data[data['Cadena'] == 'Punto de Venta']['Orden y Limpieza'].mean(), 
        data[data['Cadena'] == 'Scorpion']['Orden y Limpieza'].mean(), 
        data[data['Cadena'] == 'Zorro Abarrotero']['Orden y Limpieza'].mean()
        ]
