...
# Inicio: mar mar 19 11:50:01 CST 2019
# Para: Avignon
###
import pandas as pd
import dash
...
app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    ...
    html.H3(children='Surtido y Existencias por Cadena', style={
        'textAlign': 'center',
        'color': colors['text']
    }),
    html.H3(children='Febrero 2019', style={
        'textAlign': 'center',
        'color': colors['text']
    }),
...
def treemap(value):
    ...
    values=pd.Series(data_set['Surtido y existencias'])
    ...
    color_brewer = ['brown', 'green','red', 'blue']
    colores = {'DZ':0, 'Punto de Venta': 1, 'Zorro Abarrotero':2, 'Scorpion':3}
    shapes = []
    annotations = []
    counter = 0
    i = 0
    ...
    'layout': go.Layout(
        title='Treemap de Surtido y Existencias por Tienda',
        height=900, 
        width=1200,
