...
# Inicio: mar mar 19 12:12:51 CST 2019
# Para: Avignon
###
import pandas as pd
import dash
...
app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    ...
    html.H3(children='Trato Amable por Tienda', style={
        'textAlign': 'center',
        'color': colors['text']
    }),
...
def treemap(value):
    ...
    values=pd.Series(data_set['Trato amable'])
    ...
    'layout': go.Layout(
        title='Treemap de Trato Amable por Tienda',
        height=900, 
        width=1200,
