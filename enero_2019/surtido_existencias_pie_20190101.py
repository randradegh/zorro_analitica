...
# Inicio: mar feb 12 17:07:50 CST 2019
# Para: Avignon
###
# -*- coding: utf-8 -*-
import pandas as pd
...
values = [data[data['Cadena'] == 'Scorpion']['Surtido y existencias'].mean(), data[data['Cadena'] == 'Zorro Abarrotero']['Surtido y existencias'].mean()]
