...
# Inicio: lun mar 18 12:35:36 CST 2019
# Para: Avignon
###
import pandas as pd
import dash
...
app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    ...
    html.H3(children='Orden y Limpieza por Tienda', style={
        'textAlign': 'center',
        'color': colors['text']
    }),
    html.H4(children='Febrero 2019', style={
        'textAlign': 'center',
        'color': colors['text']
    }),
...
def treemap(value):
    ...
    values=pd.Series(data_set['Orden y Limpieza'])
    ...
    'layout': go.Layout(
        title='Treemap de Orden y Limpieza por Tienda',
        height=900, 
        width=1200,
