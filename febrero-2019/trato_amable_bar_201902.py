...
# Inicio: mar mar 19 11:59:20 CST 2019
# Para: Avignon
###
...
mean_punto=data_punto.groupby(['Municipio'], as_index=False)['Trato amable'].mean()
municipios_punto = mean_punto['Municipio']
data_punto= mean_punto['Trato amable']

data_dz=data_set.loc[data_set['Cadena'] == 'DZ']
mean_dz=data_dz.groupby(['Municipio'], as_index=False)['Trato amable'].mean()
municipios_dz = mean_dz['Municipio']
data_dz= mean_dz['Trato amable']
