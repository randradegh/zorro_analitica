...
# Inicio: mar mar 19 10:48:22 CST 2019
# Para: Avignon
###
# -*- coding: utf-8 -*-
import pandas as pd
...
values = [
        data[data['Cadena'] == 'DZ']['Seguridad Industrial'].mean(), 
        data[data['Cadena'] == 'Punto de Venta']['Seguridad Industrial'].mean(), 
        data[data['Cadena'] == 'Scorpion']['Seguridad Industrial'].mean(), 
        data[data['Cadena'] == 'Zorro Abarrotero']['Seguridad Industrial'].mean()
        ]
