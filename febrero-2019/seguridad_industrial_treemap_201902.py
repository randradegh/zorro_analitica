...
# Inicio: mar mar 19 10:53:53 CST 2019
# Para: Avignon
###
import pandas as pd
import dash
...
app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    ...
    html.H3(children='Seguridad Industrial por Tienda', style={
        'textAlign': 'center',
        'color': colors['text']
    }),
...
def treemap(value):
    ...
    values=pd.Series(data_set['Seguridad Industrial'])
    ...
    'layout': go.Layout(
        title='Treemap de Seguridad Industrial por Tienda',
        height=900, 
        width=1200,
